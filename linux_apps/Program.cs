    ...
    class UpdatePPY
    {
        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                DBConnection = new NpgsqlConnection("Database=trim_mm;Server=ec2-54-70-214-46.us-west-2.compute.amazonaws.com;Port=5432;User Id=postgres;Password=shannon;");
                START_FROM_SCRATCH:
